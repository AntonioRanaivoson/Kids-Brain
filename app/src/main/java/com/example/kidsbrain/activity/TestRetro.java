...
public class TestRetro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<RetroPhoto>>() {
            ...
            public void onFailure(Call<List<RetroPhoto>> call, Throwable t) {
                progressDoalog.dismiss();
                Toast.makeText(TestRetro.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void generateDataList(List<RetroPhoto> photoList) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(TestRetro.this);
